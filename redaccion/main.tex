...
\hypersetup{
    ...
    pdftitle={Optimización energética de sistema híbrido con bomba de calor, suelo radiante, fotovoltaica y almacenamiento para vivienda},
    pdfauthor={Luis D. Aranda Sánchez},
    pdfkeywords={optimización, derivadas adjuntas, diferenciación
...
\input{capitulos/adquisicion_de_datos/main.tex}
