...
def plot_data():
    ...
    plt.plot(hours, p_electric_demand, label="Electric power demand (kW)")
...
def plot_results(sol):
    ...
    plt.plot(hours, grid_prices_mwh, label="Grid Prices (€/MWh)")
    plt.plot(hours, p_electric_demand, label="Electric power demand (kW)")
    plt.plot(hours, (-p_gen + p_bat + p_electric_demand), label="Power from grid (kW)")
...
if __name__ == "__main__":
    ...
    p_electric_demand = get_electric_demand_powers(MAX_ELECTRIC_DEMAND, N_HOURS)
